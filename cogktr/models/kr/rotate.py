...
class RotatE(nn.Module):
    def __init__(self, entity_dict_len, relation_dict_len, embedding_dim):
        ...
        self.entity_embedding.weight.data = torch.tensor((self.entity_dict_len, self.embedding_dim),dtype=torch.complex64).uniform_(
        ...
        self.relation_embedding.weight.data = torch.tensor((self.relation_dict_len, self.embedding_dim),dtype=torch.complex64).uniform_(
            -6 / self.square, 6 / self.square)
