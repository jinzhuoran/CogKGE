...
class EVENTKG2MLoader:
    ...
    (1) load_all_data return the numpy array
    ...
    def load_all_data(self):
        ...
        # pre_node_vocab = os.path.join(self.path,"node_vocab.pkl")
        # pre_relation_vocab = os.path.join(self.path,"relation_vocab.pkl")
        # pre_time_vocab = os.path.join(self.path,"time_vocab.pkl")
