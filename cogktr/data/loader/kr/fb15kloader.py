...
class FB15KLoader:
    ...
    def load_train_data(self):
        train_data = self._load_data("freebase_mtr100_mte100-train.txt")
        return train_data

    def load_valid_data(self):
        valid_data = self._load_data("freebase_mtr100_mte100-valid.txt")
        return valid_data

    def load_test_data(self):
        test_data = self._load_data("freebase_mtr100_mte100-test.txt")
        return test_data
